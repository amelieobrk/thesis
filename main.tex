...
signature-image={\includegraphics[width=\width]{bildschirmfoto.png}}]
...
\include{chapters/2_related_work_grooming}
\include{chapters/3_related_work_transformer_based_models}
\include{chapters/4_related_work_psycholinguistics_and_LIWC}
\include{chapters/5_related_work_feature_fusion_transformer_LIWC}
\include{chapters/6_dataset_and_preprocessing}
\include{chapters/7_methodology}
\include{chapters/8_evaluation}
\include{chapters/9_discussion}
\include{chapters/10_conclusion_and_outlook}
\printbibliography
\chapter{Appendix}
\section{AI Assistance Statement}
\textbf{This work was written independently and linguistically revised with the help of ChatGPT and Grammarly.}
\include{tables/liwc22_categories_appendix_fixed}
\include{tables/appendix_liwc_table}
\include{tables/appendix_chunk_wise_liwc}
